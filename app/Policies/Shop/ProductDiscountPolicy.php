...
class ProductDiscountPolicy
{
    ...
    {
        return $user->can('view_any_shop::product::discount');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Shop\ProductDiscount  $productDiscount
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, ProductDiscount $productDiscount)
    {
        return $user->can('view_shop::product::discount');
    }
    ...
    {
        return $user->can('create_shop::product::discount');
    }
    ...
    {
        return $user->can('update_shop::product::discount');
    }
    ...
    {
        return $user->can('delete_shop::product::discount');
    }
    ...
    {
        return $user->can('delete_any_shop::product::discount');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, ProductDiscount $productDiscount)
    {
