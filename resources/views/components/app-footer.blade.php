                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="widget widget-about">
                            <img src="https://backoffice.azkiahijab.co.id/images/logo-color.png" class="footer-logo"
                    ...
                    <div class="col-sm-4 col-lg-2 offset-md-2">
                        <div class="widget">
                            ...
                            <ul class="widget-list">
                                <li><a href="about.html">Tentang Azkia Hijab</a></li>
                                <li><a href="#">Cara Belanja</a></li>
                                <li><a href="faq.html">Join Mitra</a></li>
                                <li><a href="contact.html">Kontak Kami</a></li>
                                <li><a href="login.html">Testimoni</a></li>
                            </ul><!-- End .widget-list -->
                        </div><!-- End .widget -->
