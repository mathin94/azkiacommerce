                ...
                <div class="header-left">
                    ...
                    <a href="index.html" class="logo">
                        <img src="https://backoffice.azkiahijab.co.id/images/logo-color.png"
                            alt="{{ config('app.name') }}" width="105" height="20">
                    </a>
                                    ...
                                    <div class="menu-col">
                                        ...
                                        <div class="demo-list">
                                            <div class="demo-item">
                                                <a href="index-1.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/1.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-2.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/2.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-3.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/3.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-4.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/4.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-5.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/5.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-6.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/6.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-7.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/7.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-8.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/8.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-9.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/9.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-10.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/10.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-11.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/11.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-12.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/12.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-13.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/13.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-14.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/14.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-15.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/15.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-16.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/16.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-17.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/17.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-18.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/18.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-19.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/19.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-20.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/20.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-21.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/21.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-22.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/22.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-23.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/23.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-24.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/24.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-25.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/25.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-26.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/26.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-27.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/27.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-28.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/28.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-29.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/29.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-30.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/30.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-31.html">
                                                    <span class="demo-bg"
                                                        style="background-image: url(build/assets/images/menu/demos/31.jpg);"></span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="banner banner-overlay">
                                                <a href="category.html" class="banner banner-menu">
                                                    <img src="build/assets/images/menu/banner-1.jpg" alt="Banner">
                                        ...
                                        <div class="col-md-6">
                                            <div class="banner banner-overlay">
                                                <a href="category.html">
                                                    <img src="build/assets/images/menu/banner-2.jpg" alt="Banner">
    ...
    <main class="main">
        <div class="intro-slider-container mb-0">
            <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl"
                ...
                <div class="intro-slide"
                    style="background-image: url(https://azkiahijab.co.id/blackexpo/promo/promo_upl20230119170129.jpg);">
                ...
                <div class="intro-slide"
                    style="background-image: url(https://azkiahijab.co.id/blackexpo/promo/promo_upl20221217101311.jpg);">
                    <div class="container intro-content text-center">
        ...
        <div class="container">
            <div class="heading heading-center mb-3">
                <h2 class="title">Produk Unggulan</h2><!-- End .title -->
                ...
                <ul class="nav nav-pills justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="trendy-women-link" data-toggle="tab" href="#trendy-women-tab"
                            role="tab" aria-controls="trendy-women-tab" aria-selected="false">Women</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="trendy-men-link" data-toggle="tab" href="#trendy-men-tab"
                            role="tab" aria-controls="trendy-men-tab" aria-selected="false">Men</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="trendy-access-link" data-toggle="tab" href="#trendy-access-tab"
                    ...
                    "responsive": {
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221124111248.jpg"
                                        alt="Product image" class="product-image">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221201134905.jpg"
                                ...
                                <div class="product-action product-action-transparent">
                                    <a href="#" class="btn-product btn-cart"><span>tambahkan ke
                                            keranjang</span></a>
                                </div><!-- End .product-action -->
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221130120056.jpg"
                                        alt="Product image" class="product-image">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221130094725.jpg"
                                        alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520230126091205.jpg"
                                        alt="Product image" class="product-image">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520230126090856.jpg"
                                        alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221209150636.jpg"
                                        alt="Product image" class="product-image">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221209150606.jpg"
                                        alt="Product image" class="product-image-hover">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.html">Bucket bag</a></h3>
                                <!-- End .product-title -->
                                <div class="product-price">
                                    $17.99
                                </div><!-- End .product-price -->
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221224135902.jpg"
                                        alt="Product image" class="product-image">
                                    <img src="https://azkiahijab.co.id/blackexpo/uploads/520221224135841.jpg"
                                        alt="Product image" class="product-image-hover">
                                </a>
        ...
        <div class="container pt-6 new-arrivals">
            <div class="heading heading-center mb-3">
                ...
                <ul class="nav nav-pills justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="new-cloth-link" data-toggle="tab" href="#new-cloth-tab"
                            role="tab" aria-controls="new-cloth-tab" aria-selected="false">Clothing</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="new-shoes-link" data-toggle="tab" href="#new-shoes-tab"
                            role="tab" aria-controls="new-shoes-tab" aria-selected="false">Shoes & Boots</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="new-access-link" data-toggle="tab" href="#new-access-tab"
            ...
            <div class="tab-content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="https://azkiahijab.co.id/blackexpo/uploads/520221210114739.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="https://azkiahijab.co.id/blackexpo/uploads/520221210115155.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Linen-blend dress</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                            $60.00
                                        </div><!-- End .product-price -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="https://azkiahijab.co.id/blackexpo/uploads/520221212093453.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="https://azkiahijab.co.id/blackexpo/uploads/520221212093524.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Sandals with lacing</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-7-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-7-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Paper bag trousers</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                            $60.00
                                        </div><!-- End .product-price -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-8-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-8-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-9-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-9-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-dots">
                                            <a href="#" class="active" style="background: #e3a84d;"><span
                                                    class="sr-only">Color name</span></a>
                                            <a href="#" style="background: #f48a5b;"><span
                                                    class="sr-only">Color name</span></a>
                                            <a href="#" style="background: #333333;"><span
                                                    class="sr-only">Color name</span></a>
                                        </div><!-- End .product-nav -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-10-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-10-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Silk-blend kaftan</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                            Now $370.00
                                        </div><!-- End .product-price -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-11-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-11-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Linen-blend jumpsuit</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                            $595.00
                                        </div><!-- End .product-price -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-12-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-12-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-5-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-5-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                            ...
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Linen-blend jumpsuit</a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6 col-md-4 col-lg-3">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="build/assets/images/demos/demo-5/products/product-6-1.jpg"
                                                alt="Product image" class="product-image">
                                            <img src="build/assets/images/demos/demo-5/products/product-6-2.jpg"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Sandals with lacing</a>
                                        </h3><!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="new-price">Now $70.00</span>
                                            <span class="old-price">Was $155.00</span>
                ...
                <div class="tab-pane p-0 fade" id="new-access-tab" role="tabpanel"
                    ...
                    <div class="row">
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/1.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/2.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/3.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/4.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/5.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/6.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/7.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/8.jpg" alt="img">
                        ...
                        <div class="feed-col">
                            <div class="instagram-feed">
                                <img src="build/assets/images/demos/demo-5/instagram/9.jpg" alt="img">
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="widget widget-about">
                            <img src="build/assets/images/demos/demo-5/logo-footer.png" class="footer-logo"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-8">
                                        ...
                                        <figure class="footer-payments">
                                            <img src="build/assets/images/payments.png" alt="Payment methods"
                                                width="272" height="20">
