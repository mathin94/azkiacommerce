                        ...
                        <div class="col-lg-6">
                            ...
                            @if (empty($order->canceled_at))
                                @if ($order->invoice_number == null)
                                    <label>Mohon menunggu nomor invoice terbuat sebelum melakukan pembayaran !</label>
                                @else
                            ...
                            @else
                                ...
                                <p>
                                    Jika anda tidak merasa membatalkan pesanan ini, silahkan melakukan order ulang
                                </p>
                            @endif
